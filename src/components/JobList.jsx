...
export default function JobList({ jobs, limit }) {
              ...
              <div className="px-4 py-4 sm:px-6">
                ...
                <div className="mt-2 sm:flex sm:justify-between">
                  <div className="sm:flex">
                    <p className="flex items-center text-base text-gray-500">
                      <svg className="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        <path fillRule="evenodd" d="M4 4a2 2 0 012-2h8a2 2 0 012 2v12a1 1 0 01-1.581.814L12 14.814l-2.419 1.419A1 1 0 018 15V4zm2 0v10.586l2-1.171 2 1.171V4H6z" clipRule="evenodd" />
                      </svg>
                      {job.company}
                    </p>
                  ...
                  <div className="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                    ...
                    <p>
                      Posted on <time dateTime={job.postedDate}>{job.postedDate}</time>
                    </p>
                  </div>
                </div>
                <div className="mt-2 sm:flex sm:justify-between">
